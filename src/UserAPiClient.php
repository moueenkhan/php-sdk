...
use UserAPiLib\Controllers;

/**
 * UserAPiLib client class
 */
class UserAPiClient implements ConfigurationInterface
{
    private $test;
     ...
     */
    public function getTestController(): Controllers\TestController
    {
        if ($this->test == null) {
            $this->test = new Controllers\TestController($this, $this->authManagers, $this->httpCallback);
        }
        return $this->test;
    }
